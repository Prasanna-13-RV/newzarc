...
public final class NewsRepositoryImpl implements com.newzarc.newzarcapp.domain.repository.NewsRepository {
    ...
    private final java.lang.Object getNewsFromCache(kotlin.coroutines.Continuation<? super java.util.List<com.newzarc.newzarcapp.data.model.news.NewsEntity>> continuation) {
        return null;
    }
    
    private final java.lang.Object getNewsFromRoom(kotlin.coroutines.Continuation<? super java.util.List<com.newzarc.newzarcapp.data.model.news.NewsEntity>> continuation) {
        return null;
    }
    
    private final java.lang.Object getNewsFromApi(kotlin.coroutines.Continuation<? super java.util.List<com.newzarc.newzarcapp.data.model.news.NewsEntity>> continuation) {
        return null;
    }
}