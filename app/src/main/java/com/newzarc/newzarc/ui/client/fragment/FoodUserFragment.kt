...
import com.newzarc.newzarc.databinding.FragmentFoodUserBinding
import com.newzarc.newzarc.dataclass.UserNews
import com.newzarc.newzarc.ui.client.DetailedUserActivity

class FoodUserFragment : Fragment() {

    private lateinit var binding : FragmentFoodUserBinding

    var newsList = arrayListOf<UserNews>()
    var apiSample = "https://newsdata.io/api/1/news?apikey=pub_23823de1160adf11fe144522010a017be3fd2&category=food&language=en"
