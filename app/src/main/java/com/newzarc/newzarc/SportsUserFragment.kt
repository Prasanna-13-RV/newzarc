...
import com.newzarc.newzarc.databinding.FragmentSportsUserBinding
import com.newzarc.newzarc.dataclass.UserNews
import com.newzarc.newzarc.ui.client.fragment.DetailedUserActivity

class SportsUserFragment : Fragment() {

    private lateinit var binding : FragmentSportsUserBinding

    var newsList = arrayListOf<UserNews>()
    var apiSample = "https://newsdata.io/api/1/news?apikey=pub_23823de1160adf11fe144522010a017be3fd2&category=sports&language=en"
    ...
    override fun onCreateView(
        ...
        binding = FragmentSportsUserBinding.inflate(inflater, container, false)
