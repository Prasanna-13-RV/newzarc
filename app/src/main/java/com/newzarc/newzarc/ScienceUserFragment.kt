...
import com.newzarc.newzarc.databinding.FragmentScienceUserBinding
import com.newzarc.newzarc.dataclass.UserNews
import com.newzarc.newzarc.ui.client.fragment.DetailedUserActivity

class ScienceUserFragment : Fragment() {

    private lateinit var binding : FragmentScienceUserBinding

    var newsList = arrayListOf<UserNews>()
    var apiSample = "https://newsdata.io/api/1/news?apikey=pub_23823de1160adf11fe144522010a017be3fd2&category=science&language=en"
    ...
    override fun onCreateView(
        ...
        binding = FragmentScienceUserBinding.inflate(inflater, container, false)
