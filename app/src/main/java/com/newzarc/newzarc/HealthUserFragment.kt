...
import com.newzarc.newzarc.databinding.FragmentHealthUserBinding
import com.newzarc.newzarc.dataclass.UserNews
import com.newzarc.newzarc.ui.client.fragment.DetailedUserActivity

class HealthUserFragment : Fragment() {

    private lateinit var binding : FragmentHealthUserBinding

    var newsList = arrayListOf<UserNews>()
    var apiSample = "https://newsdata.io/api/1/news?apikey=pub_23823de1160adf11fe144522010a017be3fd2&category=health&language=en"
    ...
    override fun onCreateView(
        ...
        binding = FragmentHealthUserBinding.inflate(inflater, container, false)
